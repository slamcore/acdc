...
from deep_learning_trainer.metrics.metric import Metric
from deep_learning_trainer.networks.network import Network
...
class Factory:
    ...
    def get_network(self) -> Network:
        ...
        module_str = "deep_learning_trainer.networks"
    ...
    def get_metrics(self) -> Dict[str, Metric]:
        ...
        if "metrics" in self.conf:
            for metric_dict in self.conf["metrics"]:
                ...
                metric_class = import_shortcut("deep_learning_trainer.metrics", name)
    ...
    def get_dataset(self, dataset_split: DatasetSplit) -> Dataset:
        ...
        dataset = import_shortcut("deep_learning_trainer.loaders.datasets", name)(
    ...
    def get_loader(
        ...
        loader_class = import_shortcut("deep_learning_trainer.loaders", loader_name)
